...
//    let Btncontainer= document.getElementById("continue");
...
//    Btncontainer.append(Goback, Continue);
...
// input1.type = 'text';
// input1.placeholder = 'Enter Firstname';
// input1.id = 'input1';

// var input2 = document.createElement('input');
// input2.type = 'text';
// input2.placeholder = 'Enter Lastname';
// input2.id = 'input2';

// var input3 = document.createElement('input');
// input3.type = 'number';
// input3.placeholder = 'Mobile Number';
// input3.id = 'input3';

// var input4 = document.createElement('input');
// input4.type = 'email';
// input4.placeholder = 'Enter Email';
// input4.id = 'input4';
...
//    Btncontainer.append(Continue);



// input.append(input1,input2,input3,input4)

// cred.append(input)


// }
// button1.addEventListener("click",dis1)
// dis1();
